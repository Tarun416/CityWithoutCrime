    ...
    left: 600px;"id="container">
        <form method="GET" action="" name="form1">
            <table>
				...
				<br>
                    <tr><td>
                        <input type="radio" name="check" value="1"><label>Criminal Entry</label>
                    </td><td>
                        <input type="radio" name="check" value="2"><label>Station Entry</label>
                    </td><td>
                        <input type="radio" name="check" value="3"><label>Criminal Information</label>
                    </td><td>
                        <input type="radio" name="check" value="4"><label>Station Information</label>
                    </td></tr>
                    <tr></br></tr>
                    <tr>
                        <td>
        ...
        if(isset($_GET["check_submit"]))
        {
			...
			if(($_GET["check"])==3)
            {
                header("location:criminal_information.php");
            }
			if(($_GET["check"])==4)
            {
                header("location:station_information.php");
            }
